                            ...
                            <table class="table align-middle table-nowrap mb-0" id="tasksTable">
                                ...
                                <tbody class="list form-check-all">
                                    <tr>
                                        ...
                                        <td class="id"><a href="apps-tasks-details.html" class="fw-medium link-primary">#STC501</a></td>
                                        <td class="project_name"><a href="apps-projects-overview.html" class="fw-medium link-primary">STC - v1.0.0</a></td>
                                        <td>
                                            <div class="d-flex">
                                        ...
                                        <ul class="list-unstyled vstack gap-2 mb-0">
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <span class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/avatar-4.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                    </span>
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <span class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/avatar-9.jpg') }}" alt="" class="avatar-xxs rounded-circle">
                                                    </span>
