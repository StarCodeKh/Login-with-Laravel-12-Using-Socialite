...
@section('title', 'Kanban Board | Tasks')
@section('content')
    <!-- Page-content -->
                    ...
                    <div id="unassigned-task" class="tasks">
                        ...
                        <div class="card tasks-box">
                            <div class="card-body">
                                <div class="d-flex mb-2">
                                    <div class="flex-grow-1">
                                        <h6 class="fs-15 mb-0 text-truncate task-title"><a href="apps-tasks-details.html" class="d-block">StarCode Kh - Admin Layout Design</a></h6>
                                    </div>
                                    <div class="flex-shrink-0">
                    ...
                    <div id="new-task" class="tasks">
                        <div class="card tasks-box">
                            <div class="card-body">
                                ...
                                <div class="tasks-img rounded" style="background-image: url('{{ asset('assets/images/small/img-4.jpg') }}');"></div>
                                <div class="d-flex align-items-center">
                                    <div class="flex-grow-1">
                                        <span class="badge bg-primary-subtle text-primary">UI/UX</span>
                                        ...
                                        <ul class="list-unstyled vstack gap-2 mb-0">
                                            ...
                                            <li>
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <span class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/avatar-7.jpg') }}" alt="" class="avatar-xxs rounded-circle" />
                                                    </span>
                                                    <span class="flex-grow-1 ms-2">
                                                    Michael Morris
                                                    </span>
