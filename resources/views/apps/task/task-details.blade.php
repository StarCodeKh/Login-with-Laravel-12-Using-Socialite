                            ...
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>StarCode Kh - Admin Dashboard</td>
                                    </tr>
                                    <tr>
                        ...
                        <ul class="list-unstyled vstack gap-3 mb-0">
                            <li>
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img src="{{ asset('assets/images/users/avatar-10.jpg') }}" alt="" class="avatar-xs rounded-circle material-shadow">
                                    </div>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ asset('assets/images/users/avatar-10.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                                        <div class="flex-grow-1 ms-2">
                                                            <a href="{{ route('pages/profile') }}" class="fw-medium">Tonya Noble</a>
                                                        </div>
                                                    </div>
                                                </th>
                                                <td>27 Dec, 2021</td>
