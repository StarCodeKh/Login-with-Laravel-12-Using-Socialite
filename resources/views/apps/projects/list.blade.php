                            ...
                            <div class="d-flex mb-2">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar-sm">
                                        ...
                                        <img src="{{ asset('assets/images/brands/dribbble.png') }}" alt="" class="img-fluid p-1">
                                        </span>
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex mb-2">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar-sm">
                                        ...
                                        <img src="{{ asset('assets/images/brands/mail_chimp.png') }}" alt="" class="img-fluid p-1">
                                        </span>
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex mb-2">
                                <div class="flex-shrink-0 me-3">
                                    <div class="avatar-sm">
                                        ...
                                        <img src="{{ asset('assets/images/brands/dropbox.png') }}" alt="" class="img-fluid p-1">
                                        </span>
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div class="avatar-group">
                                    <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Bonnie Haynes">
                                        <div class="avatar-xxs">
                                            <img src="{{ asset('assets/images/users/avatar-7.jpg') }}" alt="" class="rounded-circle img-fluid">
                                        </div>
                                    </a>
                    ...
                    <div class="card-body">
                        <div class="p-3 mt-n3 mx-n3 bg-secondary-subtle rounded-top">
                            ...
                            <div class="text-center pb-3">
                                <img src="{{ asset('assets/images/brands/dribbble.png') }}" alt="" height="32">
                            </div>
                        </div>
                        <div class="py-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="p-3 mt-n3 mx-n3 bg-light rounded-top">
                            ...
                            <div class="text-center pb-3">
                                <img src="{{ asset('assets/images/brands/slack.png') }}" alt="" height="32">
                            </div>
                        </div>
                        <div class="py-3">
                            ...
                            <div class="d-flex align-items-center mt-3">
                                ...
                                <div class="avatar-group">
                                    ...
                                    <img src="{{ asset('assets/images/users/avatar-9.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                    </a>
                                    ...
                                    <img src="{{ asset('assets/images/users/avatar-10.jpg') }}" alt="" class="rounded-circle avatar-xxs">
                                    </a>
                                    <a href="javascript: void(0);" class="avatar-group-item material-shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Add Members">
                                        <div class="avatar-xxs">
                                            <div class="avatar-title fs-16 rounded-circle bg-light border-dashed border text-primary">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="p-3 mt-n3 mx-n3 bg-primary-subtle rounded-top">
                            ...
                            <div class="text-center pb-3">
                                <img src="{{ asset('assets/images/brands/dropbox.png') }}" alt="" height="32">
                            </div>
                        </div>
                        <div class="py-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="p-3 mt-n3 mx-n3 bg-danger-subtle rounded-top">
                            ...
                            <div class="text-center pb-3">
                                <img src="{{ asset('assets/images/brands/mail_chimp.png') }}" alt="" height="32">
                            </div>
                        </div>
                        <div class="py-3">
