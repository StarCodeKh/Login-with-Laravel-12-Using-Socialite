...
@section('title', 'Overview | Projects')
@section('content')
    <!-- Page-content -->
                            ...
                            <div class="row mb-3">
                                <div class="col-md">
                                    <div class="row align-items-center g-3">
                                        ...
                                        <div class="col-md">
                                            <div>
                                                <h4 class="fw-bold">StarCode Kh - Admin & Dashboard</h4>
                                    ...
                                    <div class="card-body">
                                        <div data-simplebar style="height: 300px;" class="px-3 mx-n3 mb-2">
                                            <div class="d-flex mb-4">
                                                <div class="flex-shrink-0">
                                                    <img src="{{ asset('assets/images/users/avatar-8.jpg') }}" alt="" class="avatar-xs rounded-circle material-shadow" />
                                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="acitivity-timeline py-3">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/users/avatar-7.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="acitivity-item d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ asset('assets/images/users/avatar-8.jpg') }}" alt="" class="avatar-xs rounded-circle acitivity-avatar" />
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <div class="card-body px-4">
                                    <div class="row align-items-center team-row">
                                        ...
                                        <div class="col-lg-4 col">
                                            <div class="team-profile-img">
                                                <div class="avatar-lg img-thumbnail rounded-circle">
                                                    <img src="{{ asset('assets/images/users/avatar-3.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                                </div>
                                                <div class="team-content">
                                                    <a href="#" class="d-block">
                                ...
                                <div class="card-body px-4">
                                    <div class="row align-items-center team-row">
                                        ...
                                        <div class="col-lg-4 col">
                                            <div class="team-profile-img">
                                                <div class="avatar-lg img-thumbnail rounded-circle">
                                                    <img src="{{ asset('assets/images/users/avatar-8.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                                </div>
                                                <div class="team-content">
                                                    <a href="#" class="d-block">
                                ...
                                <div class="card-body px-4">
                                    <div class="row align-items-center team-row">
                                        ...
                                        <div class="col-lg-4 col">
                                            <div class="team-profile-img">
                                                <div class="avatar-lg img-thumbnail rounded-circle">
                                                    <img src="{{ asset('assets/images/users/avatar-4.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                                </div>
                                                <div class="team-content">
                                                    <a href="#" class="d-block">
                                ...
                                <div class="card-body px-4">
                                    <div class="row align-items-center team-row">
                                        ...
                                        <div class="col-lg-4 col">
                                            <div class="team-profile-img">
                                                <div class="avatar-lg img-thumbnail rounded-circle">
                                                    <img src="{{ asset('assets/images/users/avatar-7.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                                </div>
                                                <div class="team-content">
                                                    <a href="#" class="d-block">
                                ...
                                <div class="card-body px-4">
                                    <div class="row align-items-center team-row">
                                        ...
                                        <div class="col-lg-4 col">
                                            <div class="team-profile-img">
                                                <div class="avatar-lg img-thumbnail rounded-circle">
                                                    <img src="{{ asset('assets/images/users/avatar-5.jpg') }}" alt="" class="img-fluid d-block rounded-circle" />
                                                </div>
                                                <div class="team-content">
                                                    <a href="#" class="d-block">
